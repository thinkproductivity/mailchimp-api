...
exports.Mailchimp = (function() {
  ...
  Mailchimp.prototype.parseArgs = function(params, onsuccess, onerror) {
    ...
    return ref = [{}, params, onsuccess], params = ref[0], onsuccess = ref[1], onerror = ref[2], ref;
  };
...
Folders = (function() {
  ...
  Folders.prototype.add = function(params, onsuccess, onerror) {
    ...
    ref = this.master.parseArgs(params, onsuccess, onerror), params = ref[0], onsuccess = ref[1], onerror = ref[2];
